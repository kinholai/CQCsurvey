...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="surveyList4" title="预览问卷" checkbox="false" actionUrl="surveyController.do?surveyList" idField="id" fit="true" queryMode="group" pagination="false" sortName="createdTime" sortOrder="desc">
   <t:dgCol title="主键" field="id" hidden="true"></t:dgCol>
            ...
            <t:dgOpenOpt url="surveyController.do?foresee&id={id}" title="预览" openModel="OpenTab"></t:dgOpenOpt>
  </t:datagrid>
  </div>
 </div>
