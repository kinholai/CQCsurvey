...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="surveyList3" title="编辑问题" checkbox="false" actionUrl="surveyController.do?surveyList" idField="id" fit="true" queryMode="group" pagination="false" sortName="createdTime" sortOrder="desc">
   <t:dgCol title="主键" field="id" hidden="true"></t:dgCol>
            ...
            <t:dgToolBar title="编辑问题" icon="icon-edit" url="surveyController.do?updateQuestions" funname="update1"></t:dgToolBar>
  </t:datagrid>
  </div>
 </div>
