...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="surveyList1" title="创建问卷" checkbox="false" actionUrl="surveyController.do?surveyList" idField="id" fit="true" queryMode="group" pagination="false" sortName="createdTime" sortOrder="desc">
   <t:dgCol title="主键" field="id" hidden="true"></t:dgCol>
            ...
            <t:dgToolBar title="创建问卷" icon="icon-add" url="surveyController.do?addHead" funname="add"></t:dgToolBar>
  </t:datagrid>
  </div>
 </div>
