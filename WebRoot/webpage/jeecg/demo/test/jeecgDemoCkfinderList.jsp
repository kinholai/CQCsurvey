...
<div region="center" style="padding: 1px;"><t:datagrid name="jeecgDemoCkfinderList" title="ckeditor+ckfinder例子" actionUrl="jeecgDemoCkfinderController.do?datagrid" idField="id" fit="true">
	...
	<t:dgCol title="附件" field="attachment"></t:dgCol><%-- downloadName="点击下载" --%>
	<!-- 备注最好隐藏，不然你试试？ -->
	...
	<t:dgToolBar title="录入" icon="icon-add" url="jeecgDemoCkfinderController.do?addorupdate" width="880" funname="add"></t:dgToolBar>
