 ...
 <body>
  <form id="statistic1">
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable" align="center">
				...
				<tr>
				<td align="right"><input type="button" id="sub" value="以折线图显示结果"
				onclick="submit1('statisticController.do?statistic1_2');"></td>
				<td align="center"><input type="button" id="sub" value="以数据表格显示结果"
				onclick="submit1('statisticController.do?statistic1_3');"></td>
				</tr>
			</table>
		</form>
		<br/><br/><br/><br/><br/>
