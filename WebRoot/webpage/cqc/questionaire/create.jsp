...
<t:base type="jquery,easyui,tools,DatePicker"></t:base>
  <t:datagrid name="create" title="创建问卷" checkbox="false" actionUrl="questionaireController.do?questionaires" idField="id" fit="true" queryMode="group" pagination="false">
  ...
  <div id="createtb" style="padding: 5px; height: 25px">
	<div style="float: left;">
		<a href="#" class="easyui-linkbutton" plain="true" icon="icon-add" onclick="add('创建问卷','questionaireController.do?questionaire&turn=addQuestionaire','create')">创建问卷</a>
...
{
	var rows = $("#create").datagrid("getSelections");
		if(rows=='')
		{
			alertTip('请您先选择一份问卷。');
			return;
