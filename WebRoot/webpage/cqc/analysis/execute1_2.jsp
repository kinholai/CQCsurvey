...
<html style="height: 100%">
   ...
   <a href="statisticController.do?execute1_1&id=${AID }&headId=${SID }" class="easyui-linkbutton" id="btn_reset" iconCls="icon-back">返回重新查询</a>
...
function getChartData(option) {
	...
	$.ajax({
		type : "post",
		async : false, //同步执行  
		url : "statisticController.do?getC3",
		data : {
			AID : "${AID}",
			QID : "${QID}",
